...
class HyperBat extends TowerEntity {
    public static inline var ACCEL = 300;
    public static inline var MAX_SPEED = 80;
    public static inline var ACTIVATE_DISTANCE = 100;

    public static inline var BOB_SPEED = 6;
    public static inline var BOB_AMOUNT = 8;
    ...
    public function new(x:Float, y:Float) {
        super(x, y);
        type = "enemy";
        sprite = new Spritemap("graphics/hyperbat.png", 16, 16);
        sprite.add("idle", [0]);
        sprite.add("chasing", [1, 2], 10);
        sprite.play("idle");
        graphic = sprite;
